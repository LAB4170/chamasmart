...
const runRoscaActivator = async () => {
    logger.info('Running ROSCA Activation Logic...');
    try {
        ...
        logger.error('ROSCA Activation Failed', { error: error.message });
    }
};

const runRoscaPenaltyEngine = async () => {
    logger.info('Running ROSCA Penalty Engine Logic...');
