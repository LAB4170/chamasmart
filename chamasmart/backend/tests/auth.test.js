                ...
                if (text.includes("SELECT * FROM users WHERE email = $1")) {
                    return {
                        rows: [{
                            ...
                            password_hash: '$2a$10$abcdefghijklmnopqrstuvwxyz123456789012345678901', // bcrypt hash of 'Test123!@#'
                            first_name: 'Login',
                            last_name: 'Test',
                ...
                if (text.includes("SELECT * FROM users WHERE email = $1")) {
                    return {
                        rows: [{
                            user_id: 1002,
                            email: testUser.email,
                            password_hash: '$2a$10$abcdefghijklmnopqrstuvwxyz123456789012345678901',
                            first_name: 'Login',
                            last_name: 'Test',
                            phone_number: '0712345678',
                        }],
