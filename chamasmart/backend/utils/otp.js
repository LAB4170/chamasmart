...
class SMSOTP {
  ...
  async sendViaTwilio(phone, message, otp) {
    ...
    logger.warn('⚠️ Twilio SMS OTP not yet configured', { phone: this.maskPhone(phone) });
    return { success: false, error: 'Twilio not configured' };
  }

  async sendViaAfricasTalking(phone, message, otp) {
    // TODO: Implement Africa's Talking integration
    logger.warn('⚠️ Africa\'s Talking SMS OTP not yet configured', { phone: this.maskPhone(phone) });
