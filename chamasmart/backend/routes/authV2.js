...
const { apiKeyAuth, createAPIKey, listAPIKeys, revokeAPIKey, deleteAPIKey } = require('../middleware/apiKeyAuth');
...
router.post('/signup/start', applyAuthRateLimiting, authControllerV2.signupStart);

// Step 2: Verify OTP and create account
router.post('/signup/verify-otp', applyAuthRateLimiting, authControllerV2.signupVerifyOTP);

// Step 3: Google OAuth callback
router.post('/signup/google', authControllerV2.signupGoogle);

// Resend OTP
router.post('/signup/resend-otp', applyAuthRateLimiting, authControllerV2.resendOTP);
